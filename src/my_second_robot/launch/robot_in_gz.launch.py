...
def generate_launch_description():
    ...
    robot_desc_path = os.path.join(pkg_share, 'urdf', 'robot.urdf')
    ...
    gazebo = IncludeLaunchDescription(
        ...
        launch_arguments={'gz_args': f'{world_file} -r --physics-engine gz-physics-bullet-featherstone-plugin'}.items()
    )
